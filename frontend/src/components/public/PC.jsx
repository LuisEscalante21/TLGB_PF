  ...
  const getProducts = async (nextPage = 1, showNew = false) => {
    try {
      ...
      const request = await fetch(
        Global.url + "products/platform/PC/Juego/" + nextPage,
        {
          method: "GET",
          headers: {
  ...
  return (
    <>
      <div className="information-page">
        <h1>PC</h1>
        <p>
        Descubre los mejores juegos de PC, DLC's, reservas y superventas de PC en oferta especial a precios más bajos. 
        Encuentra los últimos lanzamientos, los clásicos y un montón de ofertas a bajo precio actualizadas a diario para 
        ofrecerte los mejores descuentos en PC. ¡Todos nuestros juegos de acción, aventura y deportes están disponibles 
        en formato digital a precios bajos!
        </p>
